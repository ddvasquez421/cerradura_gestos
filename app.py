...
st.markdown(
    ...
    <style>
    .stApp {
        background-image: url("https://raw.githubusercontent.com/TU_USUARIO/TU_REPOSITORIO/main/dragon.jpg"); /* ¡Asegúrate de reemplazar con la URL correcta de tu imagen! */
